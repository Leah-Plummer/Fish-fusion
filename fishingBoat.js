/* An object will be created for each fish.
    Each fish object will have four properties:
    species, string data type
    weight, number data type
    price, number data type
    amount, number data type */

// Function will be passed as an argument in fishMonger module.
...
const boatInventory = () => {
    ...
    /*  fishObjects is the array of objects which will be passed as 
    a parameter to */
